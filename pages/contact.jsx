          ...
          <div className="rounded-2xl mt-40 bg-gray-200 drop-shadow-xl flex w-1/2 overflow-hidden">
            <div className="w-1/2">
              <div className="flex items-center justify-center py-2 px-5">
                <image src="/assets/bgcoding.jpg" width={50} height={50} />
                <div className="al-5 flex flex-col">
                  <span className="text-2xl text-center font-mono font-semibold">
                    welcome
                  </span>
                  <span className="font-light">
                    {"Let's contact tp get stared using the flower apps"}
                  </span>
                </div>
              </div>
            </div>
